...
import PainterSubImagedata from './PainterSubImage';

export default class PainterSubImageList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      imagedata: PainterSubImagedata,
    };
  }
    ...
    return this.state.imagedata.map((item, index) => {
      return (
        <React.Fragment key={item.id}>
          <TouchableOpacity
            style={styles.Items}
            onPress={() => this.props.navigation.navigate('PainterItem')}>
